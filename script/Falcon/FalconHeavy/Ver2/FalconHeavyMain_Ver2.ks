//Falcon Heavy Main Script Ver2

//Continue Ascent
if ship:status = "sub_orbital" {
    runOncePath("0:/Falcon/FalconHeavy/Ver2/FalconHeavyAscent_Ver2.ks").
}
//Choose Action Mode
else {
    ...
    if ship:status = "prelaunch" {
        ...
        set button1:onclick to {runfile("0:/Falcon/FalconHeavy/Ver2/FalconHeavyAscent_Ver2.ks").}.
    }
    //Transfer
