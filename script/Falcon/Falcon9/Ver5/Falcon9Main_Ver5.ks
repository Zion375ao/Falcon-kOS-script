//Falcon9 Main Script Ver5
//Script Ver1

//Continue Ascent
if ship:status = "sub_orbital" {
    runOncePath("0:/Falcon/Falcon9/Ver5/Falcon9Ascent_Ver5.ks").
}
//Choose Action Mode
else {
    ...
    if ship:status = "prelaunch" {
        ...
        set button1:onclick to {runfile("0:/Falcon/Falcon9/Ver5/Falcon9Ascent_Ver5.ks").}.
    }
    //Transfer
    ...
    if ship:status = "prelaunch" {
        ...
        set button3:onclick to {runfile("0:/Falcon/Falcon9/Ver5/Falcon9_StaticFire_Ver5.ks").}.
    }
