...
until runmode = 0 {
    ...
    //MECO
        ...
        if (location_T = "GroundPad" and fuelamount("Falcon9Tank", "liquidfuel") < mecofuel) or (location_T = "ASDS" and lngerrordiff(refpoint(0.07, LZ_T)) > 0) or (location_T = "Expendable" and fuelamount("Falcon9Tank", "liquidfuel") = 0) {
            ...
            TerrestiaCPU:connection:sendmessage(eng).
            stage.
...
function startup {
    ...
    set TerrestiaCPU to processor("Falcon9Booster").
