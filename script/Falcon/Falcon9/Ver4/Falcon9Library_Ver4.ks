...
//KSC2 LZ1
LZlist:add(list()).
LZlist[9]:add("LZ"). //LZ status
LZlist[9]:add("LZ 1"). //LZ title
LZlist[9]:add(latlng(-0.28127, -74.38598)). //LZ latlng
LZlist[9]:add(0). //LZ alt

//KSC2 LZ2
LZlist:add(list()).
LZlist[10]:add("LZ"). //LZ status
LZlist[10]:add("LZ 2"). //LZ title
LZlist[10]:add(latlng(-0.25853, -74.39241)). //LZ latlng
LZlist[10]:add(0). //LZ alt
//-------------------------------------------------------------------
