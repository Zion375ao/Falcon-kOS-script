...
until runmode = 0 {
    ...
    //MECO
        ...
        if (LZLoc = "LZ" and fuelamount("Falcon9Tank", "liquidfuel") < mecofuel) or (LZLoc = "ASDS" and lngerrordiff(refpoint(0.07, LZPo)) > 0) or (LZLoc = "Expendable" and fuelamount("Falcon9Tank", "liquidfuel") = 0) {
