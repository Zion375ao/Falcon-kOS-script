...
LZlist[2]:add("RTLS").
LZlist[2]:add("LZ 2").
LZlist[2]:add(latlng(-0.25853, -74.39241)).
LZlist[2]:add(0).

//A Shortfall of Gravitas
LZlist:add(list()).
LZlist[3]:add("ASDS").
LZlist[3]:add("A Shortfall of Gravitas").
LZlist[3]:add(latlng(-0.156077, -60.460386)).
LZlist[3]:add(5.11).
//-------------------------------------------------------------------
...
function LatLngError {
    ...
    local ImpactPos to ImpactPoint().
